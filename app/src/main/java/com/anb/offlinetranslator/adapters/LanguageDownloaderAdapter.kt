...
class LanguageDownloaderAdapter(private var mList: List<LanguageItem>, val context: Context?, private val onLangClicked: OnLangClicked)
    : RecyclerView.Adapter<LanguageDownloaderAdapter.ViewHolder>()
{
